...
stdlib unittest, no pytest (docs/design/07-tooling.md section 6). No fixtures on disk: each failure
...
class TestReachability(TreeCase):
    def test_linked_document_is_reachable(self):
        self.write("README.md", "[rules](docs/design/03-rules.md)")
        self.write("docs/design/03-rules.md", "# Rules")
        self.assertEqual(self.problems(), [])

    def test_orphan_design_document_is_caught(self):
        self.write("README.md", "[rules](docs/design/03-rules.md)")
        self.write("docs/design/03-rules.md", "# Rules")
        self.write("docs/design/04-session.md", "# Session")
        found = self.problems()
    ...
    def test_reachability_is_transitive(self):
        ...
        self.write("README.md", "[index](docs/README.md)")
        self.write("docs/README.md", "[a record](adr/0001-x.md)")
        self.write("docs/adr/0001-x.md", "# A record")
    ...
    def test_directory_link_does_not_reach_its_contents(self):
        ...
        This is precisely why docs/README.md's record index is load-bearing: README links
        the adr/ directory, and that alone must not count as reaching each record.
        """
        self.write("README.md", "[records](docs/adr/)")
        self.write("docs/adr/0001-x.md", "# A record")
        found = self.problems()
    ...
    def test_anchor_is_stripped_before_resolving(self):
        self.write("README.md", "[rules](docs/design/03-rules.md#resolution)")
        self.write("docs/design/03-rules.md", "# Rules")
        self.assertEqual(self.problems(), [])
...
class TestAdrIndex(TreeCase):
    def test_unindexed_record_is_caught(self):
        ...
        self.write("README.md", "[index](docs/README.md)")
        self.write("docs/README.md", "[0008](adr/0008-a.md)")
        self.write("docs/adr/0008-a.md", "# 8")
        self.write("docs/adr/0009-b.md", "# 9")
        found = self.problems()
        self.assertTrue(any("0009-b.md is not listed" in p for p in found), found)

    def test_fully_indexed_passes(self):
        self.write("README.md", "[index](docs/README.md)")
        self.write("docs/README.md", "[0008](adr/0008-a.md) [0009](adr/0009-b.md)")
        self.write("docs/adr/0008-a.md", "# 8")
        self.write("docs/adr/0009-b.md", "# 9")
        self.assertEqual(self.problems(), [])
...
class TestAdrReferences(TreeCase):
    ...
    def scaffold(self):
        self.write("README.md", "[index](docs/README.md)")
        self.write("docs/README.md", "[0005](adr/0005-determinism.md)")
        self.write("docs/adr/0005-determinism.md", "# 5")

    def test_reference_to_an_existing_record_passes(self):
        self.scaffold()
        self.write("docs/design/03-rules.md", "Computed rather than inferred (ADR 0005).")
...
class TestAgainstTheRealRepo(unittest.TestCase):
    ...
    def test_every_design_document_is_reachable(self):
        ...
        for path in (REPO / "docs" / "design").rglob("*.md"):
