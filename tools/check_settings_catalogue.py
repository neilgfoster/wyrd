...
Requires the `gh` CLI. Python 3.11+, standard library only (docs/design/20-tooling.md).
"""
...
def parse_catalogue(text: str) -> list[dict]:
    ...
    A restricted-subset reader, not a general YAML parser (docs/design/20-tooling.md section 2: no
