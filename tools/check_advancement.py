...
A flat 70% (docs/design/13-diegesis.md's *expert* band, 60-70%), applied uniformly
...
that floor, and asserts it lands at the ceiling docs/design/11-character-creation.md
already gestured at.
