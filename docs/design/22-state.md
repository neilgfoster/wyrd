...
type: character
role: player
loyalty: <setting-loyalty-id>   # what decides who will travel with them (16-session.md)
career: <career-id>
career_history: []
...
Their mechanical layer is deliberately thin ([`16-session.md`](16-session.md)) — presence,
