...
everyone else** ([`16-session.md`](../design/16-session.md)) — so "may this companion join?" is a question
...
`strained` reuses **Party Tension** ([`16-session.md`](../design/16-session.md)) rather than introducing a
