...
[`03-rules.md`](../design/03-rules.md) says a spent Fate point means the character **survives and is not
...
The same moment is claimed a third time by the tone contract. [`01-principles.md`](../design/01-principles.md)
...
[`03-rules.md`](../design/03-rules.md), now with a mechanical consequence rather than a narrated one.
