...
exists in [`16-session.md`](../design/16-session.md); the fighting layer is this. One description of an
...
untrained 10% ([`03-rules.md`](../design/03-rules.md) §1), exactly as a character does. One fewer required
