...
**Does a layer exist beneath skills?** `26-authoring-a-setting.md` maps a source system onto engine
characteristics:
...
([`03-rules.md`](../design/03-rules.md) §6), rolled `d100` under. The setting supplies the name and decides
...
removes that floor, so [`03-rules.md`](../design/03-rules.md) §1 names a flat **10%** instead — anyone may
