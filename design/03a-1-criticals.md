...
five, is what modifies the Aftermath roll ([`03a-2-aftermath.md`](03a-2-aftermath.md)) — one measured
...
it is repeatable, the *when a unique family runs out* clause of [`03a-tables.md`](03a-tables.md) does
...
([`13-authoring-a-setting.md`](13-authoring-a-setting.md)). A setting may not add a fifth type: the
...
[`03a-tables.md`](03a-tables.md). The key is engine vocabulary and never rendered to the player. The
...
**Effects come from a closed set** — the same one [`03a-2-aftermath.md`](03a-2-aftermath.md) already
declares, so a critical writes the wound record every other rule already knows how to read, and the
**Mend** undertaking ([`04-session.md`](04-session.md)) already knows how to step it:
...
This is the mirror of the re-read [`03a-2-aftermath.md`](03a-2-aftermath.md) already publishes for a
...
in `setting.yaml` ([`13-authoring-a-setting.md`](13-authoring-a-setting.md)):
