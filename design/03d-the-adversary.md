...
A character ([`03b-the-character.md`](03b-the-character.md)) carries Taint, Trauma, Strain, Resolve,
...
chronicle follows — is a `character` entity ([`14-entities.md`](14-entities.md)) that *also* carries
...
|---|---|---|
| **`id`** | stable, kebab-case, unique in the repo | [`14-entities.md`](14-entities.md) |
| **`name`** | what the player ever sees | the prose |
| **`baseline`** | the percentage it tests **any skill it does not list** at | §3 below |
| **`stamina_max`** | what it survives; a critical when damage takes it below 0 | [`03-rules.md`](03-rules.md) §2, [`03a-1-criticals.md`](03a-1-criticals.md) |
...
([`13-authoring-a-setting.md`](13-authoring-a-setting.md)). An unrecognised field is how one gets
added anyway.
