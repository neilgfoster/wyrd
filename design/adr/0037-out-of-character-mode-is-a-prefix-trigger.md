...
out-of-character question becomes established fact. `10-diegesis.md`'s diegetic contract —
...
See [`04a-out-of-character-mode.md`](../04a-out-of-character-mode.md) for the full mechanism
