...
[`03-rules.md`](../03-rules.md) has instructed the GM to roll a critical "on the table for the damage
...
[`13-authoring-a-setting.md`](../13-authoring-a-setting.md), and "he is Blunt 5" in
[`10-diegesis.md`](../10-diegesis.md). Neither is a statement of the set.
