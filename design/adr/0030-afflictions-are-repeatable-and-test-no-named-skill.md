...
1. **Whether the affliction family is unique per character or repeatable.**
   [`03a-tables.md`](../03a-tables.md) defaults every table family to unique per character unless
...
hidden threshold ([`03a-3-transformations.md`](../03a-3-transformations.md)), nothing in §5 bounds
how many times a character can break this way.

**The Trauma test names no fixed skill.** It is an ordinary [`03-rules.md`](../03-rules.md) §1
...
- [`03a-4-afflictions.md`](../03a-4-afflictions.md) declares the family repeatable and the roll
