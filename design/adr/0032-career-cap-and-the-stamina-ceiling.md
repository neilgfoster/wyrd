...
Both are load-bearing for a chronicle played across years — the exact situation `03c-character-creation.md`
...
**The cap is 70%, one figure per career.** 70% is the top of the *expert* band (`10-diegesis.md`,
...
**Maximum Stamina stops climbing at 10.** `03c-character-creation.md` already used a computed
...
*expert*. Rejected: 75%+ is described in `10-diegesis.md` as identity-level mastery, and letting
...
exists: `03c-character-creation.md` already computed that the "only durable toughening" framing
