...
**Wyrd already uses wikilinks, but for data.** [`14-entities.md`](../14-entities.md) describes the
world mesh as "human-editable, diff-legible, and — because they link with `[[wikilinks]]` — a working
graph". [`07-tooling.md`](../07-tooling.md) says state is YAML with `[[wikilink]]` frontmatter, read
by a small internal parser. [`08-maintenance.md`](../08-maintenance.md) runs a referential-integrity
...
([`02-architecture.md`](../02-architecture.md)), and its design documents are read on github.com,
...
- Every document a person reads as prose — `README.md`, `CLAUDE.md`, `design/*.md`, ADRs, specs —
...
world mesh: `14-entities.md` builds a graph out of wikilinks, `08-maintenance.md` checks referential
