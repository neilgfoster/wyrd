...
[`03a-2-aftermath.md`](../03a-2-aftermath.md) hands out a wound record on five of its eight rows,
...
Meanwhile [`04-session.md`](../04-session.md) already listed **Mend** — "treat a lasting wound" — as
...
**The ladder is constrained, not chosen.** `03a-2-aftermath.md` declares a closed set of wound
...
([`09-evolution.md`](../09-evolution.md)). A character who limped for two years limped for two
...
`03a-2-aftermath.md` closes the death rows by re-reading a `death` result onto the worst non-death
...
`03a-2-aftermath.md` argued its way out of a severity field in the first place.

## Consequences

- The wound record gains `closed:`, additively ([`06-state.md`](../06-state.md)). Writing it on a
