...
[`07-tooling.md`](../07-tooling.md) and [ADR 0005](0005-deterministic-over-inference.md) exist to
remove.
...
a skill opens at 25% and rises by 5 ([`03b-the-character.md`](../03b-the-character.md)), so a gap of
...
([`03-rules.md`](../03-rules.md) §2). One is the largest number that leaves the crowd subordinate to
