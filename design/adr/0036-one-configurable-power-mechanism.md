...
[`13-authoring-a-setting.md`](../13-authoring-a-setting.md)'s hard rule — *"A setting may extend,
...
Invoking one resolves as the engine's ordinary d100 test ([`03-rules.md`](../03-rules.md) §1) —
...
[`13-authoring-a-setting.md`](../13-authoring-a-setting.md)'s hard rule exists to prevent
...
**[`03a-7-systems-of-power.md`](../03a-7-systems-of-power.md) is a new design document**,
...
([`03a-3-transformations.md`](../03a-3-transformations.md)) — no new consequence table.
...
([`03-rules.md`](../03-rules.md), [`06-state.md`](../06-state.md)) — and an Ill Omen feeds Taint
through the accrual path that already exists. `06-state.md`'s reuse guidance and the issue's own
...
content, the same boundary `13-authoring-a-setting.md` already draws for `bestiary.yaml`.
...
`13-authoring-a-setting.md`'s hard rule already forbids a setting adding a mechanism the engine
