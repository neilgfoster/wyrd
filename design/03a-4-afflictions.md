...
[`03a-3-transformations.md`](03a-3-transformations.md) already resolves the collision
...
and where the two ever appear to disagree, `03a-3-transformations.md`'s statement governs.
...
**The family is repeatable, not unique per character.** `03a-tables.md`'s default is unique per
