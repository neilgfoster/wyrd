...
are Trauma's business alone, defined in the affliction table (`03a-4-afflictions.md`, not yet
...
([`03a-tables.md`](03a-tables.md)); a duplicate roll is re-rolled.
...
[`03a-tables.md`](03a-tables.md) already requires of every family in this class.
...
including as unease** ([`10-diegesis.md`](10-diegesis.md)): the "never shown" visibility class
...
- The player character (or companion) is removed from `status: with-party`
  ([`06-state.md`](06-state.md)) and is no longer played by the operator.
...
- For a player character, this ends that character's chronicle in the ordinary way a lost
  protagonist does ([`05-campaign.md`](05-campaign.md)): a successor may follow. For a companion,
