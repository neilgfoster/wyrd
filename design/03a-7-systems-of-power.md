...
what [`13-authoring-a-setting.md`](13-authoring-a-setting.md) means when it says a setting may
...
follows immediately, using the same loop [`03a-3-transformations.md`](03a-3-transformations.md)
