...
[`13-authoring-a-setting.md`](13-authoring-a-setting.md); how the repositories divide is in
...
([`09-evolution.md`](09-evolution.md)), so one may trial a rules change while another stays
...
advances ([`05-campaign.md`](05-campaign.md)). Neither knows the other exists.
