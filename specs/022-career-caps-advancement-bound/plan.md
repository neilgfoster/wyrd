...
`docs/design/03-rules.md` §6 where "career's cap" and "completing a career" already live but are never
...
- `docs/design/03-rules.md` §6 — rewritten in place: the cap value, the completion trigger and grant,
...
- `docs/adr/0032-*.md` — records the 70%-cap and computed-Stamina-ceiling decisions and their
