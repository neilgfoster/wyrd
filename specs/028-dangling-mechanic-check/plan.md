...
**Language/Version**: Python 3.11+, standard library only (`doc/design/20-tooling.md` section 2)
...
**Constraints**: No third-party dependencies, no daemon/server, auditable top to bottom (`doc/design/20-tooling.md` section 2)
