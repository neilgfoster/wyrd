...
```
README.md  ──links──►  design/01..16, docs/README.md, settings.yaml, specs/
                            │
              docs/README.md ──links──► every docs/adr/NNNN-*.md
```
...
3. Repair `README.md` (four faults) and `docs/README.md` (ADR index).
