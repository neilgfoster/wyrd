...
| `docs/README.md` ADR index | **stops at 0008**; 0009 and 0010 exist on disk |
...
- an ADR on disk missing from `docs/README.md`'s index
...
- [ ] `docs/README.md` indexes 0009 and 0010.
