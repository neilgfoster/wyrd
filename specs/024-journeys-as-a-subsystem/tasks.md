...
- [X] T001 Write `design/17-journeys.md`: define a journey as a `scale: journey` arc
...
- [X] T007 In `design/05-campaign.md`'s elapsed-time section, add one cross-reference line to
  `17-journeys.md` for the played-journey case, changing no other prose in that section. [FR-002,
  FR-006, SC-002]
- [X] T008 In `design/15-arcs-and-beats.md`, add one cross-reference noting `scale: journey` as
  a recognised arc scale, pointing to `17-journeys.md` for its fields. [FR-001, SC-001]
- [X] T009 In `design/13-authoring-a-setting.md`'s worked example, update the "Journeys as a
...
- [X] T014 Diff `design/05-campaign.md`'s elapsed-time section before/after T007 and confirm the
