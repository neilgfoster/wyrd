...
**Rationale**: `docs/design/18-arcs-and-beats.md` already generalises containment recursively —
...
**Rationale** (clarified 2026-08-26): `docs/design/19-campaign.md` defines Threat activation as
