...
`docs/design/20-journeys.md` cold and confirming a journey resolves end to end using only what's
written, per the spec's Success Criteria.

## Prerequisites

- `docs/design/20-journeys.md` written, linked from `README.md`'s design table.
- Cross-references added to `docs/design/19-campaign.md` and `docs/design/18-arcs-and-beats.md`.
...
1. Diff `docs/design/19-campaign.md`'s elapsed-time section before and after this feature lands.
