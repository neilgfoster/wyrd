...
- [x] T011 Assert every figure `design/03-rules.md` publishes against the model, so a change to either fails rather than drifting (FR-10).
...
- [x] T023 Add the ADR 0019 row to the index in `design/README.md`.
