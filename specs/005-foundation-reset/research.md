...
`design/01-principles.md` (197 lines) was re-read in full against what the programme has surfaced:
...
Freezing the archive fixes it: `design/adr/superseded/0009-….md` means what it always meant. Only
