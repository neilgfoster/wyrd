...
- [x] T001 Re-read `design/01-principles.md` in full; record the finding in `research.md`.
...
- [x] T006 `design/README.md`: rewrite the lifecycle table; document `superseded/`.
