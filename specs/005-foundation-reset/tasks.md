...
- [x] T001 Re-read `docs/design/01-principles.md` in full; record the finding in `research.md`.
...
- [x] T006 `docs/README.md`: rewrite the lifecycle table; document `superseded/`.
