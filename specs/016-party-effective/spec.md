...
real chronicle has, and update [`docs/design/03-rules.md`](../../docs/design/03-rules.md) §7 in place.

## Why this exists

[`docs/design/03-rules.md`](../../docs/design/03-rules.md) §7 publishes the engine's only scaling equation:
...
danger is determinable from `docs/design/03-rules.md` §7 alone, and two readers computing it
...
- **SC-001**: Two readers given the same party composition and the same record compute the same
  integer `danger_effective`, from `docs/design/03-rules.md` §7 alone, without consulting each other.
...
- **SC-004**: No term in `docs/design/03-rules.md` §7 is undefined, and no reader has to consult
