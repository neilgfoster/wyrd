...
`docs/design/29-evolution.md:105` — one new field, no new version (R7).
...
an engine gap (`docs/design/24-authoring-a-setting.md`).
...
recomputes a recorded outcome (`docs/design/29-evolution.md`, R7).
