...
setting author replaces. This is the contract `docs/design/07-tables.md` publishes. It is not an
...
needs a new mechanism files an engine gap instead (`docs/design/26-authoring-a-setting.md`).
