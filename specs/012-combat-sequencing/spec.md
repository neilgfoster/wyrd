...
**The word *initiative* appears in no design document.** `docs/design/03-rules.md` §2 specifies what an
...
`docs/design/03-rules.md` §2 carries the rules as the engine's description, rewritten in place with no
...
- **SC-001**: A reader can run a complete exchange start to finish from `docs/design/03-rules.md` alone,
