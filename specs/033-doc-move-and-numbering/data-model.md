...
| `design/03b-the-character.md` | `docs/design/04-the-character.md` |
| `design/03c-character-creation.md` | `docs/design/05-character-creation.md` |
| `design/03d-the-adversary.md` | `docs/design/06-the-adversary.md` |
| `design/03a-tables.md` | `docs/design/07-tables.md` |
| `design/03a-1-criticals.md` | `docs/design/08-criticals.md` |
| `design/03a-2-aftermath.md` | `docs/design/09-aftermath.md` |
| `design/03a-3-transformations.md` | `docs/design/10-transformations.md` |
| `design/03a-4-afflictions.md` | `docs/design/11-afflictions.md` |
| `design/03a-5-oracle-answers.md` | `docs/design/12-oracle-answers.md` |
| `design/03a-6-oracle-prompts.md` | `docs/design/13-oracle-prompts.md` |
| `design/03a-7-systems-of-power.md` | `docs/design/14-systems-of-power.md` |
| `design/03e-playtest-transcript.md` | `docs/design/15-playtest-transcript.md` |
...
| `design/05-campaign.md` | `docs/design/18-campaign.md` |
| `design/06-state.md` | `docs/design/19-state.md` |
| `design/07-tooling.md` | `docs/design/20-tooling.md` |
| `design/08-maintenance.md` | `docs/design/21-maintenance.md` |
| `design/09-evolution.md` | `docs/design/22-evolution.md` |
| `design/10-diegesis.md` | `docs/design/23-diegesis.md` |
| `design/11-corpus-index.md` | `docs/design/24-corpus-index.md` |
| `design/12-parallel-chronicles.md` | `docs/design/25-parallel-chronicles.md` |
| `design/13-authoring-a-setting.md` | `docs/design/26-authoring-a-setting.md` |
| `design/14-entities.md` | `docs/design/27-entities.md` |
| `design/15-arcs-and-beats.md` | `docs/design/28-arcs-and-beats.md` |
| `design/16-chronicle-bootstrap.md` | `docs/design/29-chronicle-bootstrap.md` |
| `design/17-journeys.md` | `docs/design/30-journeys.md` |
