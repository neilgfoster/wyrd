...
Write `design/03c-character-creation.md` and ADR 0014, with starting Stamina derived by
...
2. `design/03c-character-creation.md` — the procedure, the values, the setting's obligations.
