...
- [X] **T002** Write `docs/design/14-oracle-answers.md`:
  ...
  - The roll declaration block (`key`, `die`, `modifier`, `uniqueness`, `extra row fields`),
    matching the format used in `docs/design/07-transformations.md` / `03a-4-afflictions.md`.
...
- [X] **T003** Amend `docs/design/01-principles.md` so the GM contract states the oracle obligation,
  agreeing with T002's wording rather than restating it differently.
- [X] **T004** Amend `docs/design/04-tables.md`'s index row for Oracles: link
