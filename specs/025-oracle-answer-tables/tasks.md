...
- [X] **T002** Write `design/03a-5-oracle-answers.md`:
  ...
  - The roll declaration block (`key`, `die`, `modifier`, `uniqueness`, `extra row fields`),
    matching the format used in `design/03a-3-transformations.md` / `03a-4-afflictions.md`.
...
- [X] **T003** Amend `design/01-principles.md` so the GM contract states the oracle obligation,
  agreeing with T002's wording rather than restating it differently.
- [X] **T004** Amend `design/03a-tables.md`'s index row for Oracles: link
