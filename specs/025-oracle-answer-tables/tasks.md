...
- [X] **T002** Write `docs/design/12-oracle-answers.md`:
  ...
  - The roll declaration block (`key`, `die`, `modifier`, `uniqueness`, `extra row fields`),
    matching the format used in `docs/design/10-transformations.md` / `03a-4-afflictions.md`.
...
- [X] **T004** Amend `docs/design/07-tables.md`'s index row for Oracles: link
