...
Write `design/03b-the-character.md`, record the decision as an ADR, and correct the four places that
contradict it.
...
`design/03b-the-character.md`, and in `README.md`'s reading order it sits **immediately after
...
1. `design/03b-the-character.md`.
2. ADR 0013 — no characteristics, no skill vocabulary.
3. The five corrections.
4. `README.md` reading order; `design/README.md` index.
