...
Write `docs/design/10-the-character.md`, record the decision as an ADR, and correct the four places that
contradict it.
...
`docs/design/10-the-character.md`, and in `README.md`'s reading order it sits **immediately after
...
1. `docs/design/10-the-character.md`.
