...
decided. [`13-authoring-a-setting.md`](../../design/13-authoring-a-setting.md), in the engine/setting
contract:
...
*Extend* presupposes a base list to add to. [`07-tooling.md`](../../design/07-tooling.md) agrees with
