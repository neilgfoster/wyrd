...
- [x] T011 `design/03a-1-criticals.md` — the family: key, die, modifier, lowest possible total, uniqueness, extra fields, and why each is what it is (FR-003, FR-004, FR-006).
...
- [x] T018 `design/03a-tables.md` — the Criticals index row gains its link and its stated uniqueness (FR-011).
- [x] T019 `design/03-rules.md` §2 — the critical rule points at the new file and names the four types (FR-011).
- [x] T020 `design/03a-2-aftermath.md` — the criticals/Aftermath boundary table gains the mortal blow, and the death-row section gains its mirror (FR-008, FR-011).
- [x] T021 `design/13-authoring-a-setting.md` — the override example verified against the published keys (FR-011).
...
- [x] T025 Add both ADR rows to the index in `design/README.md`, and link the new design document from the hub (FR-011).
