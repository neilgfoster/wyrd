...
2. **Exactly +0 when the party matches `written_for`**, or the identity case that
   [ADR 0024](../../docs/adr/0024-a-party-is-worth-less-than-its-head-count.md) exists to protect
...
- rejects an **out-of-range value**: an armour rank outside the published set, a damage type outside
  the closed four ([ADR 0022](../../docs/adr/0022-four-damage-types-named-for-the-wound.md)), a
