...
- [x] T031 `docs/adr/0025` — the thin adversary block, against the full character model (FR-002).
- [x] T032 `docs/adr/0026` — the skill adjustment: additive, identity-exact, ladder-bounded, against multiplying the percentage by `danger_effective` (FR-013a).
