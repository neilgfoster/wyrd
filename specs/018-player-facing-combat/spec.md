...
([`03-rules.md`](../../design/03-rules.md) §1, [ADR 0016](../../design/adr/0016-opposed-tests-need-a-successful-actor.md)):
...
- **Q: Does the telling blow's degree threshold change under the new mapping, and how are degrees
  ...
  ([ADR 0001](../../design/adr/0001-resolution.md)), which is the drift class this repo is
...
skill and the opponent's relevant skill (or `baseline`, [`03d-the-adversary.md`](../../design/03d-the-adversary.md)
...
- **FR-008**: [ADR 0016](../../design/adr/0016-opposed-tests-need-a-successful-actor.md)'s status
...
- **FR-013**: `design/03-rules.md` §1 and §2 MUST be updated in place to describe the player-facing
