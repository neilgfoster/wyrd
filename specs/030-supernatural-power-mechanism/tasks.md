...
- [ ] T002 Write `design/adr/0036-one-configurable-power-mechanism.md` recording the load-bearing
      ...
      `design/adr/0035-opposed-tests-generalise-to-the-player-facing-roll.md`).
...
- [ ] T003 [US1] Write `design/03a-7-systems-of-power.md`: the schema table (`id`, `name`,
...
- [ ] T004 [US1] Add a link to `design/03a-7-systems-of-power.md` from `design/README.md`'s index
...
**Independent Test**: read `design/03a-7-systems-of-power.md`'s resolution section against
`design/03-rules.md` §1 and confirm no new dice mechanism, difficulty rule, or assistance rule is
introduced — the only new behaviour is cost application and the training gate.

- [ ] T008 [US2] Add the resolution section to `design/03a-7-systems-of-power.md`: invocation is
...
- [ ] T009 [US2] Add a one-line cross-reference at the end of `design/03-rules.md` §1 pointing to
      `design/03a-7-systems-of-power.md`, matching how other consequence chains are
...
**Independent Test**: read the Ill Omen section against `design/03a-3-transformations.md` and
...
- [ ] T011 [US3] Add the Ill Omen section to `design/03a-7-systems-of-power.md`: on Ill Omen, the
...
- [ ] T013 [P] Run `python3 tools/check_docs.py` and confirm `design/03a-7-systems-of-power.md` is
...
- [ ] T017 Re-read `design/03a-7-systems-of-power.md` end to end for the recurring fault classes in
