...
- [ ] T003 [US1] Write `docs/design/09-systems-of-power.md`: the schema table (`id`, `name`,
...
- [ ] T004 [US1] Add a link to `docs/design/09-systems-of-power.md` from `docs/README.md`'s index
...
**Independent Test**: read `docs/design/09-systems-of-power.md`'s resolution section against
...
- [ ] T008 [US2] Add the resolution section to `docs/design/09-systems-of-power.md`: invocation is
...
- [ ] T009 [US2] Add a one-line cross-reference at the end of `docs/design/03-rules.md` §1 pointing to
      `docs/design/09-systems-of-power.md`, matching how other consequence chains are
...
**Independent Test**: read the Ill Omen section against `docs/design/07-transformations.md` and
...
- [ ] T011 [US3] Add the Ill Omen section to `docs/design/09-systems-of-power.md`: on Ill Omen, the
...
- [ ] T013 [P] Run `python3 tools/check_docs.py` and confirm `docs/design/09-systems-of-power.md` is
...
- [ ] T017 Re-read `docs/design/09-systems-of-power.md` end to end for the recurring fault classes in
