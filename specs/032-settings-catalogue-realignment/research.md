...
doesn't exist, on demand rather than in CI (`docs/design/20-tooling.md` §1: this repo has no CI yet).
...
structure `docs/design/20-tooling.md` §3 asks for even in the zero-backend tooling case).
