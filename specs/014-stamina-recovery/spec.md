...
[`docs/design/16-session.md`](../../docs/design/16-session.md) already lists **Mend** — "treat a lasting
...
`docs/design/16-session.md`'s **Mend** undertaking either gains a defined effect or is removed. An
