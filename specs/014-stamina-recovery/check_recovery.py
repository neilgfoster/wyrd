...
numbers at all -- nothing in design/ restored Stamina, and design/03a-2-aftermath.md declined the
...
1. **A starting character has Stamina 6**, and a completed career grants +1 -- the only durable
   toughening (design/03c-character-creation.md, design/03-rules.md section 6).
...
4. **A critical happens below 0 Stamina**, and the dropped combatant rolls on the Aftermath table
   at +5 per point below zero (design/03a-2-aftermath.md).
5. **The Aftermath table's own weights**: a lasting mark 71%, death 23%, unweighted across drops
   of one to twelve (design/03a-2-aftermath.md).
6. **Strain recovers 1 at a Rally** (design/03-rules.md section 5) -- the rate this rule borrows.
...
# Beats -- and therefore Rallies -- a real session produces. design/04-session.md: a single beat
...
# closed: design/03a-2-aftermath.md makes anything outside it a load error.
...
# are the difficulty table's own rungs (design/03-rules.md section 1), and "closed" is the record
# kept and marked, never deleted (design/09-evolution.md).
MEND_LADDER = {
    "skill": [-10, -5, None],
    "stamina_max": [-1, None],
    "dread": [+1, None],
