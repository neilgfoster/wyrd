...
- [X] T005 Add **Standing** to the engine-label table at the top of `design/03-rules.md`,
...
- [X] T006 In `design/03-rules.md` (near the other tracks, §4-5's neighbourhood), state what
...
- [X] T007 Rewrite `design/04-session.md:112`'s Upkeep line in place: "lose 1 Standing, or spend
...
- [X] T008 Expand `design/13-authoring-a-setting.md:19`'s `gear.yaml` line into the field list
  ...
  FR-004, SC-002]
- [X] T009 In `design/03-rules.md` §2, add the wealth (coin) definition: a small stated count, no
...
- [X] T010 In `design/10-diegesis.md`'s "Inventory — realistic, not logistic" section, extend the
  ...
  [FR-006, SC-004]
- [X] T011 In `design/03-rules.md` §2, next to the existing casual/martial sentence, state the
...
- [X] T012 Write `design/adr/0033-standing-and-the-material-economy.md`: Standing kept and
...
- [X] T013 Add ADR 0033 to `design/README.md`'s index.
...
- [X] T015 Read `design/04-session.md`'s Upkeep step cold, with no other document open; confirm
