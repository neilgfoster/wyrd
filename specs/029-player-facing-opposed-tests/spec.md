...
- **FR-005**: Assistance, declaration and the untrained-10% rule MUST compose with the generalised
  ...
  composition rule.
- **FR-006**: `docs/design/03-rules.md` §1's "Opposed tests" subsection MUST be rewritten to the
...
- **FR-007**: Every place in `design/` that cites "opposed test" as a live mechanism (not merely
  ...
  shape.
- **FR-008**: [ADR 0016](../../docs/adr/0016-opposed-tests-need-a-successful-actor.md)'s
...
- The two-player-controlled-entities case is expected to be resolved with the same tool ADR 0016
  ...
  shape.
- No new engine vocabulary is introduced; this feature edits `docs/design/03-rules.md` §1 in place and
