...
script settles whether that is still true after the generalisation, so `design/adr/0035-*.md` and
`design/03-rules.md` section 1 are written from what it finds rather than from an assumption.
...
def degrees(effective: int, roll: int) -> int:
    """design/03-rules.md section 1's formula, fed effective% as the skill value -- unchanged
...
HISTORICAL_ADR_FILES = {
    "design/adr/0016-opposed-tests-need-a-successful-actor.md",
    "design/adr/0017-assistance-group-tests-and-extended-tasks.md",
    "design/adr/0018-combat-sequencing.md",
    "design/adr/0019-a-crowd-is-defined-by-one-blow-and-a-skill-gap.md",
    "design/adr/0027-combat-rolls-belong-to-the-player.md",
    "design/adr/0028-the-telling-blow-threshold-and-the-damage-finding.md",
...
# The index entry in design/README.md naming ADR 0016 by its title is a pointer to a historical
# record, not a live use of the mechanism -- unaffected by this feature.
HISTORICAL_INDEX_FILES = {"design/README.md"}

# The one live document: design/03-rules.md section 1 defines the two-sided shape today and
...
LIVE_MECHANISM_FILE = "design/03-rules.md"
