...
GitHub does not promise. Fails `doc/design/20-tooling.md` §1. Rejected.
...
`doc/design/20-tooling.md` §3 lays out `engine/wyrd/` for the game engine's CLI. This tool is not engine
