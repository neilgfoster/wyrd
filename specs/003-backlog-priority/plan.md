...
**Language**: Python 3.11+, standard library only (`design/07-tooling.md` §2). No pytest —
`unittest` (§6).
...
| 50 | #4 Onboard settings | A setting overlays a finished engine (`design/13-authoring-a-setting.md`), so this is last by construction. Undecomposed. |
