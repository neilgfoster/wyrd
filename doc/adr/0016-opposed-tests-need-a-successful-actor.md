...
([`03-rules.md`](../design/03-rules.md) §2) — on one sentence:
...
([`03-rules.md`](../design/03-rules.md) §1), which is negative on a failure. Subtracting a negative
...
twenty-minute session [`01-principles.md`](../design/01-principles.md) requires.
