...
`16-session.md` measures **Party Tension**, 0-6, rising toward a break, and nothing a
...
Meanwhile `16-session.md` already carries **Bond** (-3..+3, per companion, toward the player
...
- `16-session.md`'s companion section states the two-layer split (narrative / mechanical) and
...
- A companion at Bond -3 remains, as `16-session.md` already says, "more interesting than one who
